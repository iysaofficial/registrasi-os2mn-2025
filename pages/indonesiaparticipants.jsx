...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbxu-oqso_LUaIAax93kxpIiCZQO32zASooMdZDpiRvAbKWtCOSf1rFsnppwz7WoVBqu0w/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HALLO PESERTA OS2MN 2025, Mohon perhatikan informasi berikut ini
            ...
            <form name="regist-form">
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="KATEGORI_OLIMPIADE" className="form-label">
                    Kategori Olimpiade
                  </label>
                  <p>
                    Noted : Untuk peserta MI/MIN dan MTs/MTsN hanya tersedia kategori matematika
                  </p>
                  <select
                    type="text"
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Madrasah Ibtidaiyah">
                      Madrasah Ibtidaiyah
                    </option>
                    <option value="Madrasah Tsanawiyah">
                      Madrasah Tsanawiyah
                    </option>
                    <option value="Madrasah Aliyah">
                      Madrasah Aliyah
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi OS2MN 2025
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
